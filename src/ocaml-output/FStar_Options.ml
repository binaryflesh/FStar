...
let (get_force : unit -> Prims.bool) =
  fun uu____3011  -> lookup_opt "force" as_bool 
let (get_fs_typ_app : unit -> Prims.bool) =
  fun uu____3020  -> lookup_opt "fs_typ_app" as_bool 
let (get_hide_uvar_nums : unit -> Prims.bool) =
  fun uu____3029  -> lookup_opt "hide_uvar_nums" as_bool 
let (get_hint_info : unit -> Prims.bool) =
  fun uu____3038  -> lookup_opt "hint_info" as_bool 
let (get_hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3049  -> lookup_opt "hint_dir" (as_option as_string) 
let (get_hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3063  -> lookup_opt "hint_file" (as_option as_string) 
let (get_in : unit -> Prims.bool) =
  fun uu____3075  -> lookup_opt "in" as_bool 
let (get_ide : unit -> Prims.bool) =
  fun uu____3084  -> lookup_opt "ide" as_bool 
let (get_lsp : unit -> Prims.bool) =
  fun uu____3093  -> lookup_opt "lsp" as_bool 
let (get_include : unit -> Prims.string Prims.list) =
  fun uu____3104  -> lookup_opt "include" (as_list as_string) 
let (get_print : unit -> Prims.bool) =
  fun uu____3116  -> lookup_opt "print" as_bool 
let (get_print_in_place : unit -> Prims.bool) =
  fun uu____3125  -> lookup_opt "print_in_place" as_bool 
let (get_initial_fuel : unit -> Prims.int) =
  fun uu____3134  -> lookup_opt "initial_fuel" as_int 
let (get_initial_ifuel : unit -> Prims.int) =
  fun uu____3143  -> lookup_opt "initial_ifuel" as_int 
let (get_keep_query_captions : unit -> Prims.bool) =
  fun uu____3152  -> lookup_opt "keep_query_captions" as_bool 
let (get_lax : unit -> Prims.bool) =
  fun uu____3161  -> lookup_opt "lax" as_bool 
let (get_load : unit -> Prims.string Prims.list) =
  fun uu____3172  -> lookup_opt "load" (as_list as_string) 
let (get_log_queries : unit -> Prims.bool) =
  fun uu____3184  -> lookup_opt "log_queries" as_bool 
let (get_log_types : unit -> Prims.bool) =
  fun uu____3193  -> lookup_opt "log_types" as_bool 
let (get_max_fuel : unit -> Prims.int) =
  fun uu____3202  -> lookup_opt "max_fuel" as_int 
let (get_max_ifuel : unit -> Prims.int) =
  fun uu____3211  -> lookup_opt "max_ifuel" as_int 
let (get_min_fuel : unit -> Prims.int) =
  fun uu____3220  -> lookup_opt "min_fuel" as_int 
let (get_MLish : unit -> Prims.bool) =
  fun uu____3229  -> lookup_opt "MLish" as_bool 
let (get_no_default_includes : unit -> Prims.bool) =
  fun uu____3238  -> lookup_opt "no_default_includes" as_bool 
let (get_no_extract : unit -> Prims.string Prims.list) =
  fun uu____3249  -> lookup_opt "no_extract" (as_list as_string) 
let (get_no_location_info : unit -> Prims.bool) =
  fun uu____3261  -> lookup_opt "no_location_info" as_bool 
let (get_no_plugins : unit -> Prims.bool) =
  fun uu____3270  -> lookup_opt "no_plugins" as_bool 
let (get_no_smt : unit -> Prims.bool) =
  fun uu____3279  -> lookup_opt "no_smt" as_bool 
let (get_normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____3288  -> lookup_opt "normalize_pure_terms_for_extraction" as_bool 
let (get_odir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3299  -> lookup_opt "odir" (as_option as_string) 
let (get_ugly : unit -> Prims.bool) =
  fun uu____3311  -> lookup_opt "ugly" as_bool 
let (get_prims : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3322  -> lookup_opt "prims" (as_option as_string) 
let (get_print_bound_var_types : unit -> Prims.bool) =
  fun uu____3334  -> lookup_opt "print_bound_var_types" as_bool 
let (get_print_effect_args : unit -> Prims.bool) =
  fun uu____3343  -> lookup_opt "print_effect_args" as_bool 
let (get_print_full_names : unit -> Prims.bool) =
  fun uu____3352  -> lookup_opt "print_full_names" as_bool 
let (get_print_implicits : unit -> Prims.bool) =
  fun uu____3361  -> lookup_opt "print_implicits" as_bool 
let (get_print_universes : unit -> Prims.bool) =
  fun uu____3370  -> lookup_opt "print_universes" as_bool 
let (get_print_z3_statistics : unit -> Prims.bool) =
  fun uu____3379  -> lookup_opt "print_z3_statistics" as_bool 
let (get_prn : unit -> Prims.bool) =
  fun uu____3388  -> lookup_opt "prn" as_bool 
let (get_quake_lo : unit -> Prims.int) =
  fun uu____3397  -> lookup_opt "quake_lo" as_int 
let (get_quake_hi : unit -> Prims.int) =
  fun uu____3406  -> lookup_opt "quake_hi" as_int 
let (get_query_stats : unit -> Prims.bool) =
  fun uu____3415  -> lookup_opt "query_stats" as_bool 
let (get_record_hints : unit -> Prims.bool) =
  fun uu____3424  -> lookup_opt "record_hints" as_bool 
let (get_record_options : unit -> Prims.bool) =
  fun uu____3433  -> lookup_opt "record_options" as_bool 
...
let rec (specs_with_types :
  ...
  fun uu____5251  ->
    ...
    (FStar_Getopt.noshort, "fuel",
      (PostProcessed
         (((fun uu___8_5946  ->
              match uu___8_5946 with
              | String s ->
                  let p f =
                    let uu____5957 = FStar_Util.int_of_string f  in
                    Int uu____5957  in
                  let uu____5959 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____5988 -> failwith "unexpected value for --fuel"
                     in
                  (match uu____5959 with
                   | (min1,max1) ->
                       ((let uu____6006 = p min1  in
                         set_option "initial_fuel" uu____6006);
                        (let uu____6009 = p max1  in
                         set_option "max_fuel" uu____6009);
                        String s))
              | uu____6011 -> failwith "impos")),
    ...
    (FStar_Getopt.noshort, "ifuel",
      (PostProcessed
         (((fun uu___9_6041  ->
              match uu___9_6041 with
              | String s ->
                  let p f =
                    let uu____6052 = FStar_Util.int_of_string f  in
                    Int uu____6052  in
                  let uu____6054 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6083 -> failwith "unexpected value for --fuel"
                     in
                  (match uu____6054 with
                   | (min1,max1) ->
                       ((let uu____6101 = p min1  in
                         set_option "initial_ifuel" uu____6101);
                        (let uu____6104 = p max1  in
                         set_option "max_ifuel" uu____6104);
                        String s))
              | uu____6106 -> failwith "impos")),
           (SimpleStr "non-negative integer or pair of non-negative integers"))),
    ...
    (FStar_Getopt.noshort, "quake",
      (PostProcessed
         (((fun uu___10_6563  ->
              match uu___10_6563 with
              | String s ->
                  let p f =
                    let uu____6574 = FStar_Util.int_of_string f  in
                    Int uu____6574  in
                  let uu____6576 =
                    match FStar_Util.split s "/" with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6605 -> failwith "unexpected value for --quake"
                     in
                  (match uu____6576 with
                   | (min1,max1) ->
                       ((let uu____6623 = p min1  in
                         set_option "quake_lo" uu____6623);
                        (let uu____6626 = p max1  in
                         set_option "quake_hi" uu____6626);
                        String s))
              | uu____6628 -> failwith "impos")),
           (SimpleStr "non-negative integer or pair of non-negative integers"))),
    ...
    (FStar_Getopt.noshort, "__debug_embedding",
      (WithSideEffect
         (((fun uu____7467  -> FStar_ST.op_Colon_Equals debug_embedding true)),
           (Const (Bool true)))),
      "Debug messages for embeddings/unembeddings of natively compiled terms");
    (FStar_Getopt.noshort, "eager_embedding",
      (WithSideEffect
         (((fun uu____7511  -> FStar_ST.op_Colon_Equals eager_embedding true)),
           (Const (Bool true)))),
    ...
    (104, "help",
      (WithSideEffect
         (((fun uu____7608  ->
              (let uu____7610 = specs ()  in display_usage_aux uu____7610);
              FStar_All.exit Prims.int_zero)), (Const (Bool true)))),
      "Display this information")]

and (specs : unit -> FStar_Getopt.opt Prims.list) =
  fun uu____7641  ->
    let uu____7644 = specs_with_types ()  in
    FStar_List.map
      (fun uu____7675  ->
         match uu____7675 with
         | (short,long,typ,doc) ->
             let uu____7697 =
               let uu____7711 = arg_spec_of_opt_type long typ  in
               (short, long, uu____7711, doc)  in
             mk_spec uu____7697) uu____7644

let (settable : Prims.string -> Prims.bool) =
  fun uu___11_7726  ->
    match uu___11_7726 with
    | "abort_on" -> true
    | "admit_except" -> true
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____7963  ->
          ...
          | (uu____7978,x,uu____7980,uu____7981) -> settable x))
  
let (display_usage : unit -> unit) =
  fun uu____7997  ->
    let uu____7998 = specs ()  in display_usage_aux uu____7998
...
let (uu___is_File_argument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | File_argument uu____8030 -> true
    | uu____8033 -> false
  
let (__proj__File_argument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | File_argument uu____8043 -> uu____8043
  ...
  fun uu____8096  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____8102 =
             let uu____8106 = FStar_ST.op_Bang file_list_  in
             FStar_List.append uu____8106 [i]  in
           FStar_ST.op_Colon_Equals file_list_ uu____8102)
       in
    let uu____8163 =
      let uu____8167 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____8167
       in
    (res, uu____8163)
  
let (file_list : unit -> Prims.string Prims.list) =
  fun uu____8209  -> FStar_ST.op_Bang file_list_ 
let (restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res)
  ...
  fun should_clear  ->
    ...
    (let r =
       let uu____8252 = specs ()  in
       FStar_Getopt.parse_cmdline uu____8252 (fun x  -> ())  in
     (let uu____8259 =
        let uu____8265 =
          let uu____8266 =
            FStar_List.map (fun _8270  -> String _8270) old_verify_module  in
          List uu____8266  in
        ("verify_module", uu____8265)  in
      set_option' uu____8259);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____8286 =
        let uu____8288 =
          let uu____8290 =
            let uu____8292 = FStar_Util.get_file_extension f1  in
            FStar_String.length uu____8292  in
          (FStar_String.length f1) - uu____8290  in
        uu____8288 - Prims.int_one  in
      FStar_String.substring f1 Prims.int_zero uu____8286  in
    FStar_String.lowercase f2
  
let (should_verify : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8305 = get_lax ()  in
    if uu____8305
    then false
    else
...
let (should_verify_file : Prims.string -> Prims.bool) =
  fun fn  ->
    let uu____8326 = module_name_of_file_name fn  in should_verify uu____8326
...
let (dont_gen_projectors : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8354 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____8354 (FStar_List.existsb (module_name_eq m))
  
let (should_print_message : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8372 = should_verify m  in
    if uu____8372 then m <> "Prims" else false
  
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____8389  ->
    let cache_dir =
      let uu____8394 = get_cache_dir ()  in
      match uu____8394 with
      | FStar_Pervasives_Native.None  -> []
      | FStar_Pervasives_Native.Some c -> [c]  in
    let uu____8408 = get_no_default_includes ()  in
    if uu____8408
    then
      let uu____8414 = get_include ()  in
      FStar_List.append cache_dir uu____8414
    else
      (let lib_paths =
         let uu____8425 = FStar_Util.expand_environment_variable "FSTAR_LIB"
            in
       ...
       let uu____8468 =
         let uu____8472 =
           let uu____8476 = get_include ()  in
           FStar_List.append uu____8476 ["."]  in
         FStar_List.append lib_paths uu____8472  in
       FStar_List.append cache_dir uu____8468)
  
let (find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option)
  =
  let file_map = FStar_Util.smap_create (Prims.of_int (100))  in
  fun filename  ->
    let uu____8507 = FStar_Util.smap_try_find file_map filename  in
        ...
        let result =
          try
            (fun uu___593_8538  ->
               match () with
               | () ->
                   let uu____8542 = FStar_Util.is_path_absolute filename  in
                   if uu____8542
                   then
                     ...
                     (let uu____8558 =
                        let uu____8562 = include_path ()  in
                        FStar_List.rev uu____8562  in
                      FStar_Util.find_map uu____8558
                        (fun p  ->
                           let path =
                             if p = "."
                             then filename
          ...
          with | uu___592_8590 -> FStar_Pervasives_Native.None  in
...
let (prims_basename : unit -> Prims.string) =
  fun uu____8641  ->
    let uu____8642 = prims ()  in FStar_Util.basename uu____8642
  
let (pervasives : unit -> Prims.string) =
  fun uu____8650  ->
    let filename = "FStar.Pervasives.fst"  in
    let uu____8654 = find_file filename  in
...
let (pervasives_basename : unit -> Prims.string) =
  fun uu____8673  ->
    let uu____8674 = pervasives ()  in FStar_Util.basename uu____8674
  
let (pervasives_native_basename : unit -> Prims.string) =
  fun uu____8682  ->
    let filename = "FStar.Pervasives.Native.fst"  in
    let uu____8686 = find_file filename  in
...
let (prepend_cache_dir : Prims.string -> Prims.string) =
  fun fpath  ->
    let uu____8726 = get_cache_dir ()  in
    match uu____8726 with
    | FStar_Pervasives_Native.None  -> fpath
    | FStar_Pervasives_Native.Some x ->
        let uu____8735 = FStar_Util.basename fpath  in
        FStar_Util.join_paths x uu____8735
...
let (parse_settings :
  ...
  fun ns  ->
    ...
    let with_cache f s =
      let uu____8857 = FStar_Util.smap_try_find cache s  in
    ...
    let parse_one_setting s =
      ...
      then ([], true)
        ...
        then ([], false)
          ...
          then
            (let path =
               let uu____9011 = FStar_Util.substring_from s Prims.int_one  in
               path_of_text uu____9011  in
             (path, false))
          else
            (let s1 =
               if FStar_Util.starts_with s "+"
    ...
    let uu____9034 =
      FStar_All.pipe_right ns
       ...
       in
    FStar_All.pipe_right uu____9034 FStar_List.rev
  
let (__temp_no_proj : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9199 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____9199 (FStar_List.contains s)
  
let (__temp_fast_implicits : unit -> Prims.bool) =
  fun uu____9214  -> lookup_opt "__temp_fast_implicits" as_bool 
let (admit_smt_queries : unit -> Prims.bool) =
  fun uu____9223  -> get_admit_smt_queries () 
let (admit_except : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9232  -> get_admit_except () 
let (cache_checked_modules : unit -> Prims.bool) =
  fun uu____9239  -> get_cache_checked_modules () 
let (cache_off : unit -> Prims.bool) = fun uu____9246  -> get_cache_off () 
let (cmi : unit -> Prims.bool) = fun uu____9253  -> get_cmi () 
type codegen_t =
  | OCaml 
  | FSharp 
  | Kremlin 
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____9263 -> false
  
let (uu___is_FSharp : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | FSharp  -> true | uu____9274 -> false
  
let (uu___is_Kremlin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Kremlin  -> true | uu____9285 -> false
  
let (uu___is_Plugin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Plugin  -> true | uu____9296 -> false
  
let (codegen : unit -> codegen_t FStar_Pervasives_Native.option) =
  fun uu____9305  ->
    let uu____9306 = get_codegen ()  in
    FStar_Util.map_opt uu____9306
      (fun uu___12_9312  ->
         match uu___12_9312 with
         | "OCaml" -> OCaml
         | "FSharp" -> FSharp
         | "Kremlin" -> Kremlin
         | "Plugin" -> Plugin
         | uu____9318 -> failwith "Impossible")
  
let (codegen_libs : unit -> Prims.string Prims.list Prims.list) =
  fun uu____9331  ->
    let uu____9332 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____9332
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let (debug_any : unit -> Prims.bool) =
  fun uu____9358  -> let uu____9359 = get_debug ()  in uu____9359 <> [] 
let (debug_module : Prims.string -> Prims.bool) =
  fun modul  ->
    let uu____9376 = get_debug ()  in
...
let (debug_at_level : Prims.string -> debug_level_t -> Prims.bool) =
  fun modul  ->
    fun level  ->
      (let uu____9401 = get_debug ()  in
       FStar_All.pipe_right uu____9401
         (FStar_List.existsb (module_name_eq modul)))
        && (debug_level_geq level)
  
let (profile_group_by_decls : unit -> Prims.bool) =
  fun uu____9416  -> get_profile_group_by_decl () 
let (defensive : unit -> Prims.bool) =
  fun uu____9423  -> let uu____9424 = get_defensive ()  in uu____9424 <> "no" 
let (defensive_fail : unit -> Prims.bool) =
  fun uu____9434  ->
    let uu____9435 = get_defensive ()  in uu____9435 = "fail"
  
let (dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9447  -> get_dep () 
let (detail_errors : unit -> Prims.bool) =
  fun uu____9454  -> get_detail_errors () 
let (detail_hint_replay : unit -> Prims.bool) =
  fun uu____9461  -> get_detail_hint_replay () 
let (doc : unit -> Prims.bool) = fun uu____9468  -> get_doc () 
let (dump_module : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9478 = get_dump_module ()  in
    FStar_All.pipe_right uu____9478 (FStar_List.existsb (module_name_eq s))
  
let (eager_subtyping : unit -> Prims.bool) =
  fun uu____9493  -> get_eager_subtyping () 
let (expose_interfaces : unit -> Prims.bool) =
  fun uu____9500  -> get_expose_interfaces () 
let (force : unit -> Prims.bool) = fun uu____9507  -> get_force () 
let (fs_typ_app : Prims.string -> Prims.bool) =
  fun filename  ->
    let uu____9517 = FStar_ST.op_Bang light_off_files  in
    FStar_List.contains filename uu____9517
  
let (full_context_dependency : unit -> Prims.bool) = fun uu____9553  -> true 
let (hide_uvar_nums : unit -> Prims.bool) =
  fun uu____9561  -> get_hide_uvar_nums () 
let (hint_info : unit -> Prims.bool) =
  fun uu____9568  -> (get_hint_info ()) || (get_query_stats ()) 
let (hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9577  -> get_hint_dir () 
let (hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9586  -> get_hint_file () 
let (hint_file_for_src : Prims.string -> Prims.string) =
  fun src_filename  ->
    let uu____9596 = hint_file ()  in
    match uu____9596 with
    | FStar_Pervasives_Native.Some fn -> fn
    | FStar_Pervasives_Native.None  ->
        let file_name =
          let uu____9607 = hint_dir ()  in
          match uu____9607 with
          | FStar_Pervasives_Native.Some dir ->
              let uu____9615 = FStar_Util.basename src_filename  in
              FStar_Util.concat_dir_filename dir uu____9615
          | uu____9617 -> src_filename  in
        FStar_Util.format1 "%s.hints" file_name
  
let (ide : unit -> Prims.bool) = fun uu____9628  -> get_ide () 
let (print : unit -> Prims.bool) = fun uu____9635  -> get_print () 
let (print_in_place : unit -> Prims.bool) =
  fun uu____9642  -> get_print_in_place () 
let (initial_fuel : unit -> Prims.int) =
  fun uu____9649  ->
    let uu____9650 = get_initial_fuel ()  in
    let uu____9652 = get_max_fuel ()  in Prims.min uu____9650 uu____9652
  
let (initial_ifuel : unit -> Prims.int) =
  fun uu____9660  ->
    let uu____9661 = get_initial_ifuel ()  in
    let uu____9663 = get_max_ifuel ()  in Prims.min uu____9661 uu____9663
  
let (interactive : unit -> Prims.bool) =
  fun uu____9671  -> (get_in ()) || (get_ide ()) 
let (lax : unit -> Prims.bool) = fun uu____9678  -> get_lax () 
let (load : unit -> Prims.string Prims.list) = fun uu____9687  -> get_load () 
let (legacy_interactive : unit -> Prims.bool) = fun uu____9694  -> get_in () 
let (lsp_server : unit -> Prims.bool) = fun uu____9701  -> get_lsp () 
let (log_queries : unit -> Prims.bool) =
  fun uu____9708  -> get_log_queries () 
let (keep_query_captions : unit -> Prims.bool) =
  fun uu____9715  -> (log_queries ()) && (get_keep_query_captions ()) 
let (log_types : unit -> Prims.bool) = fun uu____9722  -> get_log_types () 
let (max_fuel : unit -> Prims.int) = fun uu____9729  -> get_max_fuel () 
let (max_ifuel : unit -> Prims.int) = fun uu____9736  -> get_max_ifuel () 
let (min_fuel : unit -> Prims.int) = fun uu____9743  -> get_min_fuel () 
let (ml_ish : unit -> Prims.bool) = fun uu____9750  -> get_MLish () 
let (set_ml_ish : unit -> unit) =
  fun uu____9756  -> set_option "MLish" (Bool true) 
let (no_default_includes : unit -> Prims.bool) =
  fun uu____9765  -> get_no_default_includes () 
let (no_extract : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9775 = get_no_extract ()  in
    FStar_All.pipe_right uu____9775 (FStar_List.existsb (module_name_eq s))
  
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____9790  -> get_normalize_pure_terms_for_extraction () 
let (no_location_info : unit -> Prims.bool) =
  fun uu____9797  -> get_no_location_info () 
let (no_plugins : unit -> Prims.bool) = fun uu____9804  -> get_no_plugins () 
let (no_smt : unit -> Prims.bool) = fun uu____9811  -> get_no_smt () 
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9820  -> get_odir () 
let (ugly : unit -> Prims.bool) = fun uu____9827  -> get_ugly () 
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____9834  -> get_print_bound_var_types () 
let (print_effect_args : unit -> Prims.bool) =
  fun uu____9841  -> get_print_effect_args () 
let (print_implicits : unit -> Prims.bool) =
  fun uu____9848  -> get_print_implicits () 
let (print_real_names : unit -> Prims.bool) =
  fun uu____9855  -> (get_prn ()) || (get_print_full_names ()) 
let (print_universes : unit -> Prims.bool) =
  fun uu____9862  -> get_print_universes () 
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____9869  -> get_print_z3_statistics () 
let (quake_lo : unit -> Prims.int) = fun uu____9876  -> get_quake_lo () 
let (quake_hi : unit -> Prims.int) = fun uu____9883  -> get_quake_hi () 
let (query_stats : unit -> Prims.bool) =
  fun uu____9890  -> get_query_stats () 
let (record_hints : unit -> Prims.bool) =
  fun uu____9897  -> get_record_hints () 
let (record_options : unit -> Prims.bool) =
  fun uu____9904  -> get_record_options () 
let (reuse_hint_for : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9913  -> get_reuse_hint_for () 
let (silent : unit -> Prims.bool) = fun uu____9920  -> get_silent () 
let (smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____9927  -> get_smtencoding_elim_box () 
let (smtencoding_nl_arith_native : unit -> Prims.bool) =
  fun uu____9934  ->
    let uu____9935 = get_smtencoding_nl_arith_repr ()  in
    uu____9935 = "native"
  
let (smtencoding_nl_arith_wrapped : unit -> Prims.bool) =
  fun uu____9945  ->
    let uu____9946 = get_smtencoding_nl_arith_repr ()  in
    uu____9946 = "wrapped"
  
let (smtencoding_nl_arith_default : unit -> Prims.bool) =
  fun uu____9956  ->
    let uu____9957 = get_smtencoding_nl_arith_repr ()  in
    uu____9957 = "boxwrap"
  
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____9967  ->
    let uu____9968 = get_smtencoding_l_arith_repr ()  in
    uu____9968 = "native"
  
let (smtencoding_l_arith_default : unit -> Prims.bool) =
  fun uu____9978  ->
    let uu____9979 = get_smtencoding_l_arith_repr ()  in
    uu____9979 = "boxwrap"
  
let (smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____9989  -> get_smtencoding_valid_intro () 
let (smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____9996  -> get_smtencoding_valid_elim () 
let (tactic_raw_binders : unit -> Prims.bool) =
  fun uu____10003  -> get_tactic_raw_binders () 
let (tactics_failhard : unit -> Prims.bool) =
  fun uu____10010  -> get_tactics_failhard () 
let (tactics_info : unit -> Prims.bool) =
  fun uu____10017  -> get_tactics_info () 
let (tactic_trace : unit -> Prims.bool) =
  fun uu____10024  -> get_tactic_trace () 
let (tactic_trace_d : unit -> Prims.int) =
  fun uu____10031  -> get_tactic_trace_d () 
let (tactics_nbe : unit -> Prims.bool) =
  fun uu____10038  -> get_tactics_nbe () 
let (tcnorm : unit -> Prims.bool) = fun uu____10045  -> get_tcnorm () 
let (timing : unit -> Prims.bool) = fun uu____10052  -> get_timing () 
let (trace_error : unit -> Prims.bool) =
  fun uu____10059  -> get_trace_error () 
let (unthrottle_inductives : unit -> Prims.bool) =
  fun uu____10066  -> get_unthrottle_inductives () 
let (unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____10073  -> get_unsafe_tactic_exec () 
let (use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____10080  -> get_use_eq_at_higher_order () 
let (use_hints : unit -> Prims.bool) = fun uu____10087  -> get_use_hints () 
let (use_hint_hashes : unit -> Prims.bool) =
  fun uu____10094  -> get_use_hint_hashes () 
let (use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____10103  -> get_use_native_tactics () 
let (use_tactics : unit -> Prims.bool) =
  fun uu____10110  -> get_use_tactics () 
let (using_facts_from :
  unit -> (Prims.string Prims.list * Prims.bool) Prims.list) =
  fun uu____10126  ->
    let uu____10127 = get_using_facts_from ()  in
...
let (vcgen_optimize_bind_as_seq : unit -> Prims.bool) =
  fun uu____10181  ->
    let uu____10182 = get_vcgen_optimize_bind_as_seq ()  in
    FStar_Option.isSome uu____10182
  
let (vcgen_decorate_with_type : unit -> Prims.bool) =
  fun uu____10193  ->
    let uu____10194 = get_vcgen_optimize_bind_as_seq ()  in
    match uu____10194 with
    | FStar_Pervasives_Native.Some "with_type" -> true
    | uu____10202 -> false
  
let (warn_default_effects : unit -> Prims.bool) =
  fun uu____10213  -> get_warn_default_effects () 
let (z3_exe : unit -> Prims.string) =
  fun uu____10220  ->
    let uu____10221 = get_smt ()  in
    match uu____10221 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
  
let (z3_cliopt : unit -> Prims.string Prims.list) =
  fun uu____10239  -> get_z3cliopt () 
let (z3_refresh : unit -> Prims.bool) = fun uu____10246  -> get_z3refresh () 
let (z3_rlimit : unit -> Prims.int) = fun uu____10253  -> get_z3rlimit () 
let (z3_rlimit_factor : unit -> Prims.int) =
  fun uu____10260  -> get_z3rlimit_factor () 
let (z3_seed : unit -> Prims.int) = fun uu____10267  -> get_z3seed () 
let (use_two_phase_tc : unit -> Prims.bool) =
  fun uu____10274  ->
    (get_use_two_phase_tc ()) &&
      (let uu____10276 = lax ()  in Prims.op_Negation uu____10276)
  
let (no_positivity : unit -> Prims.bool) =
  fun uu____10284  -> get_no_positivity () 
let (ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____10291  -> get_ml_no_eta_expand_coertions () 
let (warn_error : unit -> Prims.string) =
  fun uu____10298  ->
    let uu____10299 = get_warn_error ()  in
    FStar_String.concat "" uu____10299
  
let (use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____10310  -> get_use_extracted_interfaces () 
let (use_nbe : unit -> Prims.bool) = fun uu____10317  -> get_use_nbe () 
let (trivial_pre_for_unannotated_effectful_fns : unit -> Prims.bool) =
  fun uu____10324  -> get_trivial_pre_for_unannotated_effectful_fns () 
let with_saved_options : 'a . (unit -> 'a) -> 'a =
  fun f  ->
    let uu____10341 =
      let uu____10343 = trace_error ()  in Prims.op_Negation uu____10343  in
    if uu____10341
    then
      (push ();
       (let r =
          try
            (fun uu___800_10358  ->
               match () with
               | () -> let uu____10363 = f ()  in FStar_Util.Inr uu____10363)
              ()
          with | uu___799_10365 -> FStar_Util.Inl uu___799_10365  in
        pop ();
        (match r with
        ...
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____10533  ->
                ...
                | (path,uu____10544) -> matches_path m_components path))
         in
      match uu____10491 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____10563,flag) -> flag
...
let (should_extract : Prims.string -> Prims.bool) =
  fun m  ->
    let m1 = FStar_String.lowercase m  in
    let uu____10628 = get_extract ()  in
    match uu____10628 with
    | FStar_Pervasives_Native.Some extract_setting ->
        ((let uu____10643 =
            let uu____10659 = get_no_extract ()  in
            let uu____10663 = get_extract_namespace ()  in
            let uu____10667 = get_extract_module ()  in
            (uu____10659, uu____10663, uu____10667)  in
    ...
    | FStar_Pervasives_Native.None  ->
        let should_extract_namespace m2 =
          let uu____10721 = get_extract_namespace ()  in
        ...
        let should_extract_module m2 =
          let uu____10749 = get_extract_module ()  in
          ...
          | l ->
           ...
           in
        (let uu____10771 = no_extract m1  in Prims.op_Negation uu____10771)
          &&
          (let uu____10774 =
             let uu____10785 = get_extract_namespace ()  in
             let uu____10789 = get_extract_module ()  in
             (uu____10785, uu____10789)  in
...
let (should_be_already_cached : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____10829 = get_already_cached ()  in
...
let (error_flags : unit -> error_flag Prims.list) =
  ...
  fun uu____10862  ->
    ...
    let uu____10865 = FStar_Util.smap_try_find cache we  in
...
let (profile_enabled :
  ...
  fun modul_opt  ->
    fun phase  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____10909 = get_profile_component ()  in
          matches_namespace_filter_opt phase uu____10909
      | FStar_Pervasives_Native.Some modul ->
          (let uu____10920 = get_profile ()  in
           matches_namespace_filter_opt modul uu____10920) &&
            (let uu____10927 = get_profile_component ()  in
             matches_namespace_filter_opt phase uu____10927)
